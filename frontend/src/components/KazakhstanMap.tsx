...
// ─── Region definitions ───────────────────────────────────────────────────────
// viewBox 0 0 780 510 — approximate geographic layout of Kazakhstan
    ...
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      >
        ...
        {REGIONS.filter(r => !!r.cx).map((r) => {
          ...
          const fill = scoreColor(stat?.score);
          return (
            <g key={cr.td_name} style={{ cursor: 'pointer' }}
